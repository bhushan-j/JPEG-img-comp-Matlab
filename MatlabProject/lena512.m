...
fid = fopen('srm.txt','w'); % opens a file “file1.txt”
fwrite(fid, img_var_dct_qt, 'int8'); % stores quantized into file1.txt
fclose(fid); % closes the file
zip('srm','srm.txt'); % compresses file1.txt into file1.zip
imwrite(img,'srm.jpg','Quality',q);
var_jpg=imread('srm.jpg');
sizQ = dir('srm.zip'); % writes information about “file1.zip”
