...
fid = fopen('vsa.txt','w'); % opens a file “file1.txt”
fwrite(fid, img_var_dct_qt, 'int8'); % stores quantized into file1.txt
fclose(fid); % closes the file
zip('vsa','vsa.txt'); % compresses file1.txt into file1.zip
imwrite(img,'vsa.jpg','Quality',q);
var_jpg=imread('vsa.jpg');
sizQ = dir('vsa.zip'); % writes information about “file1.zip”
