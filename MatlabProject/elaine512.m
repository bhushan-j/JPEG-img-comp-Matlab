...
fid = fopen('elaine512.txt','w'); % opens a file “file1.txt”
fwrite(fid, img_var_dct_qt, 'int8'); % stores quantized into file1.txt
fclose(fid); % closes the file
zip('elaine512','elaine512.txt'); % compresses file1.txt into file1.zip
imwrite(img,'elaine512.jpg','Quality',q);
var_jpg=imread('elaine512.jpg');
sizQ = dir('elaine512.zip'); % writes information about “file1.zip”
filesizeQ = sizQ.bytes; % writes in filesizeQ the number of
sizJ=dir('elaine512.jpg');
